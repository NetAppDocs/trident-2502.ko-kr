...
* *CVS-Performance*: 기본 Trident 서비스 유형입니다. 이 성능 최적화 서비스 유형은 성능을 중시하는 프로덕션 워크로드에 가장 적합합니다. CVS-Performance 서비스 유형은 최소 100GiB 크기의 볼륨을 지원하는 하드웨어 옵션입니다. 다음 중 하나를 선택할 수 있습니다 link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["3가지 서비스 레벨"^]:
+
** `standard`
** `premium`
** `extreme`
